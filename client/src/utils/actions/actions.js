...
export const CAUSE_LOADING = "CAUSE_LOADING";
export const CAUSE_LOADED = "CAUSE_LOADED";
//NEWS
...
export const TREND_LOADING = "TREND_LOADING";
export const TREND_LOADED = "TREND_LOADED";
//ERRORS AND FAILS
